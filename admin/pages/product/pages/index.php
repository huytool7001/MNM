            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <a href="./form.php"><button style="float: right; width: 10%;" type="button" class="btn btn-block btn-success btn-sm">+ Thêm mới</button></a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                          ...
                          '<tr>
                            ...
                            <td>
                              ...
                              <button data-id="' . $row['idCategory_product'] . '" type="button" class="btn btn-sm btn-primary btn-danger btnDelete" data-toggle="modal" data-target="#modal-default">
                                Xoá
                              </button>
                            </td>
                          </tr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Không thể khôi phục lại sản phẩm bị xoá. Bạn có muốn tiếp tục?</p>
        </div>
