                        ...
                        while ($row = mysqli_fetch_array($result)) {
                          ...
                          '<tr>
                            ...
                            <td>
                              ...
                              <button data-id="' . $row['id'] . '" type="button" class="btn btn-sm btn-primary btn-danger btnDelete" data-toggle="modal" data-target="#modal-default">
                                Xoá
                              </button>
                            </td>
                          </tr>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Không thể khôi phục lại đơn hàng bị xoá. Bạn có muốn tiếp tục?</p>
        </div>
