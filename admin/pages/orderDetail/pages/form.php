                ...
                <form id="quickForm" method="POST" action="../scripts/crui.php">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input value="<?= $customer ?>" name="customer" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Số điện thoại</label>
                      <input value="<?= $phone ?>" name="phone" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Địa chỉ</label>
                      <input value="<?= $address ?>" name="address" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Tỉnh/TP</label>
                      <input value="<?= $city ?>" name="city" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Loại địa chỉ</label>
                      <select class="form-control select2" value="<?= $addressType ?>" name="addressType">
                        <option value="Nhà riêng" <?= $addressType == "Nhà riêng" ? 'selected="selected"' : '' ?> >Nhà riêng</option>
